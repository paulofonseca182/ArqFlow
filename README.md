...
Relatórios já possui filtros por período, cliente e projeto, exportação CSV e atalhos preservando o escopo ativo sem criar módulo novo. A interface também recebeu ajuste global de responsividade para evitar botões fora de cards, filtros e modais. A próxima etapa recomendada é validar relatórios filtrados com dados reais e avaliar se vale adicionar detalhamento de pagamentos/tarefas/visitas críticos.
