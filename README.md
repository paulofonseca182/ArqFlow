...
Relatórios já possui filtros por período, cliente e projeto, exportação CSV e atalhos preservando o escopo ativo sem criar módulo novo. Os destinos dos atalhos foram alinhados e validados com dados reais para aplicar o recorte de cliente/projeto, incluindo Orçamentos por projeto. A próxima etapa recomendada é avaliar se vale adicionar detalhamento de pagamentos, tarefas e visitas críticos.
